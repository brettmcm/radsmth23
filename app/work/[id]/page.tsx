    ...
    return (
        <article>
            <ul className="cs-meta">
                <li><h3>Client</h3>{metaData.title}</li>
                <li><h3>Category</h3>{metaData.category}</li>
                <li><h3>Credit</h3>{metaData.credit}</li>
                <li><h3>Location</h3>{metaData.location}</li>
                <li><h3>Year</h3>{metaData.year}</li>
            </ul>
